  ...
  <div class="login-container">
    <el-form ref="loginForm" class="login-form" auto-complete="on" label-position="left">
      ...
      <div class="title-container">
        <h3 class="title">Financial Block Chain</h3>
      </div>
      <el-select v-model="value" placeholder="Please select account" class="login-select" @change="selectGet">
        <el-option
      ...
      <div class="tips">
        <span style="margin-right:20px;">tips: select different account to simulate transaction</span>
      </div>
  ...
  methods: {
    handleLogin() {
      if (this.value) {
        ...
        this.$message('Please select account!')
      }
    },
    selectGet(accountId) {
