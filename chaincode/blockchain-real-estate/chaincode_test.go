...
func Test_QueryAccountList(t *testing.T) {
	stub := initTest(t)
	fmt.Println(fmt.Sprintf("1 test all account\n%s",
		string(checkInvoke(t, stub, [][]byte{
			[]byte("queryAccountList"),
		}).Payload)))
	fmt.Println(fmt.Sprintf("2. test multiple account\n%s",
		string(checkInvoke(t, stub, [][]byte{
			[]byte("queryAccountList"),
			[]byte("5feceb66ffc8"),
			[]byte("6b86b273ff34"),
		}).Payload)))
	fmt.Println(fmt.Sprintf("3. test single account\n%s",
		string(checkInvoke(t, stub, [][]byte{
			[]byte("queryAccountList"),
			[]byte("4e07408562be"),
		}).Payload)))
	fmt.Println(fmt.Sprintf("4. test invalid account\n%s",
		string(checkInvoke(t, stub, [][]byte{
			[]byte("queryAccountList"),
			[]byte("0"),
		}).Payload)))
...
func Test_CreatePortfolioInfo(t *testing.T) {
	stub := initTest(t)
	fmt.Println(fmt.Sprintf("1 test create portfolio\n%s",
		string(checkInvoke(t, stub, [][]byte{
			[]byte("createPortfolioInfo"),
			[]byte("d4735e3a265e"),
			[]byte("100"),
			[]byte("200"),
			[]byte("300"),
	...
	fmt.Println(fmt.Sprintf("2 test create invalid portfolio\n%s",
	string(checkInvoke(t, stub, [][]byte{
		[]byte("createPortfolioInfo"),
		[]byte("d4735e3a265e"),
		[]byte("aa"),
	...
	fmt.Println(fmt.Sprintf("5 test query all transactions\n%s",
	string(checkInvoke(t, stub, [][]byte{
		[]byte("queryTransactionInfoList"),
	}).Payload)))


	fmt.Println(fmt.Sprintf("6 test query someone transaction\n%s",
	string(checkInvoke(t, stub, [][]byte{
		[]byte("queryTransactionInfoList"),
		[]byte("d4735e3a265e"),
	}).Payload)))

	fmt.Println(fmt.Sprintf("7 test query invalid person transaction\n%s",
	string(checkInvoke(t, stub, [][]byte{
		[]byte("queryTransactionInfoList"),
		[]byte("qwe"),
	}).Payload)))
...
// test query function
func Test_QueryTransactionInfoList(t *testing.T) {
	stub := initTest(t)
	fmt.Println(fmt.Sprintf("1 test create portfolio\n%s",
		string(checkInvoke(t, stub, [][]byte{
			[]byte("createPortfolioInfo"),
	...
	fmt.Println(fmt.Sprintf("2 test query all transactions info\n%s",
	string(checkInvoke(t, stub, [][]byte{
		[]byte("queryTransactionInfoList"),
	}).Payload)))


	fmt.Println(fmt.Sprintf("3 test query someone transaction info\n%s",
	string(checkInvoke(t, stub, [][]byte{
		[]byte("queryTransactionInfoList"),
		[]byte("d4735e3a265e"),
	}).Payload)))

	fmt.Println(fmt.Sprintf("4 test query invalid person transaction info\n%s",
	string(checkInvoke(t, stub, [][]byte{
		[]byte("queryTransactionInfoList"),
		[]byte("qwe"),
	}).Payload)))

	fmt.Println(fmt.Sprintf("5 test query all money transactions info\n%s",
	string(checkInvoke(t, stub, [][]byte{
		[]byte("queryMoneyTransactionList"),
	}).Payload)))


	fmt.Println(fmt.Sprintf("6 test query someone  money transaction info\n%s",
	string(checkInvoke(t, stub, [][]byte{
		[]byte("queryMoneyTransactionList"),
		[]byte("d4735e3a265e"),
	}).Payload)))

	fmt.Println(fmt.Sprintf("7 test query invalid person money transaction info\n%s",
	string(checkInvoke(t, stub, [][]byte{
		[]byte("queryMoneyTransactionList"),
		[]byte("qwe"),
	}).Payload)))

	// fmt.Println(fmt.Sprintf("8 test query all commodity transactions info\n%s",
	// string(checkInvoke(t, stub, [][]byte{
	// 	[]byte("queryCommodityTransactionList"),
	// }).Payload)))


	// fmt.Println(fmt.Sprintf("9 test query someone  commodity transaction info\n%s",
	// string(checkInvoke(t, stub, [][]byte{
	// 	[]byte("queryCommodityTransactionList"),
	// 	[]byte("d4735e3a265e"),
	// }).Payload)))

	// fmt.Println(fmt.Sprintf("10 test query invalid person commodity transaction info\n%s",
	// string(checkInvoke(t, stub, [][]byte{
	// 	[]byte("queryCommodityTransactionList"),
	// 	[]byte("qwe"),
	// }).Payload)))
...
// test create portfolio
func Test_adjustNetWorth(t *testing.T) {
	stub := initTest(t)
	
	fmt.Println(fmt.Sprintf("1 test create portfolio\n%s",
		string(checkInvoke(t, stub, [][]byte{
			[]byte("queryCommodityTypeList"),
			}).Payload)))
